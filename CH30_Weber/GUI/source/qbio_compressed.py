...
#        self.plottingwindow.title('Figure')
    ...
    def PlotParameterSpace(self):
        ...
        if checkfun==0:
            ...
            self.fig.clf() 
            self.currplot.set(2)
            self.ParSpace_Plot(k12plot,k21plot,k23plot,k32plot,kr2plot,kr3plot,gmmplot,betplot,k12list,k23list,k21list,k32list,kr2list,kr3list,gmmlist,betlist)             
    ...
    def Save_Config(self):
        f = open(path.normpath(path.dirname(path.abspath(__file__))+'\GUI.config.txt'),'w')
        try:
    ...
    def MH_par_space_call(self):
        ...
        self.fig.clf() 
        self.currplot.set(2)
        self.ParSpace_Plot(k12plot,k21plot,k23plot,k32plot,kr2plot,kr3plot,gmmplot,betplot,k12list,k23list,k21list,k32list,kr2list,kr3list,gmmlist,betlist,alpha =al, color =pco )             
...
#        
        ...
        try:
            ...
            with open(path.normpath(path.dirname(path.abspath(__file__))+'\GUI.config.txt')) as config:
               self.Clear_All_Entries()
               for line in config:
    ...
    def ParSpace_Plot(self,k12plot,k21plot,k23plot,k32plot,kr2plot,kr3plot,gmmplot,betplot,k12list,k23list,k21list,k32list,kr2list,kr3list,gmmlist,betlist,**kwargs):
        ...
        time = np.linspace(0,1,len(varlist[0][:]))
